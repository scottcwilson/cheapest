...
define('TABLE_HEADING_PRODUCTS', 'Item Description');
define('TABLE_HEADING_TAX', 'Tax');
define('TABLE_HEADING_TOTAL', 'Total');
define('TABLE_HEADING_PRICE_EXCLUDING_TAX', 'Price Each');
define('TABLE_HEADING_PRICE_INCLUDING_TAX', 'Price (taxed)');
define('TABLE_HEADING_TOTAL_EXCLUDING_TAX', 'Total (no tax)');
define('TABLE_HEADING_TOTAL_INCLUDING_TAX', 'Total Price');
define('TABLE_HEADING_UPDATED_BY', 'Updated By');

define('TABLE_HEADING_CUSTOMER_NOTIFIED', 'Member Notified');
define('TABLE_HEADING_DATE_ADDED', 'Purchase Date');

define('ENTRY_CUSTOMER', 'Member:');
...
define('TEXT_DATE_ORDER_CREATED', '<b>Purchase Date:</b>&nbsp;'); 
...
define('TEXT_INFO_IP_ADDRESS', '<b>IP Address:</b> ');
...
define('TABLE_HEADING_CUSTOMER_COMMENTS', 'Member<br />Comments');
