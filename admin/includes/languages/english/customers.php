...
define('TABLE_HEADING_ID', 'Member ID#');
...
define('TABLE_HEADING_AUTHORIZATION_APPROVAL', 'Status');
...
define('TABLE_HEADING_COMPANY','Banknote Preference');
...
define('CUSTOMERS_AUTHORIZATION', 'Member Account Status:&nbsp;');
