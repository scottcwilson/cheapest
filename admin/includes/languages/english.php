...
define('BOX_CONFIGURATION_SMI_SETTINGS', 'Social Media Icons');
...
define('CATEGORY_COMPANY', 'Preferred Currency');
...
define('ENTRY_COMPANY', 'Currency name:');
...
define('ENTRY_TELEPHONE_NUMBER', 'Phone Number:');
