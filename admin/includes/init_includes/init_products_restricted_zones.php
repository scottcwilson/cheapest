...
$module_constant = 'PRODUCTS_RESTRICTED_ZONE_VERSION';
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/products_restricted_zones';
$module_name = "Products Restricted Zone";
