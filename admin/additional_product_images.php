    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <?php
		  ...
		  $curr_page = FILENAME_ADDITIONAL_IMAGES;
		  require('includes/modules/products_previous_next_display.php');
		 ?></table>        
        </td>
      </tr>
      <tr>
        <td>
        	<?php echo zen_draw_form('related_products', FILENAME_ADDITIONAL_IMAGES_UPLOAD, '', 'get');
				...
				echo zen_image_submit('button_additional_images.gif', BUTTON_ADDITIONAL_IMAGES);
			?>
               </form>
         </td>
  </tr>
