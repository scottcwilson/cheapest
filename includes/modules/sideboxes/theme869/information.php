...
//auctions information
  if (DEFINE_AUCTION_STATUS <= 1) {
    $information[] = '<a href="' . zen_href_link(FILENAME_PRODUCT_AUCTION) . '">' . BOX_INFORMATION_AUCTION . '</a>';
  }
  
  if (DEFINE_REWARD_POINTS_STATUS <= 1) {

    $information[] = '<a href="' . zen_href_link(FILENAME_REWARD_POINTS) . '">' . BOX_INFORMATION_REWARD_POINTS . '</a>';
