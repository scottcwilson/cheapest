  ...
  die('Illegal Access');
    ...
    if (isset($_GET['pID']) && empty($_POST)) {
      $product = $db->Execute("select pd.products_name, pd.products_description, pd.products_url,
                                      ...
                                      p.products_image, p.products_youtube, p.products_price, p.products_virtual, p.products_weight,
...
?>
          ...
          <tr>
            ...
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;'; ?><script>dateAvailable.writeControl(); dateAvailable.dateFormat="yyyy-MM-dd";</script></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
...
<!-- BOF youtube add-on -->
	  <tr bgcolor="#DDEACC">
            <td class="main"><?php echo TEXT_PRODUCTS_YOUTUBE; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_youtube', htmlspecialchars(stripslashes($pInfo->products_youtube), ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_PRODUCTS, 'products_youtube')); ?></td>
          </tr>
<!-- EOF youtube add-on -->
          <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
