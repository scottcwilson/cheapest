...
<div id="checkoutBillto" class="floatingBox">
...
<br>
<div class="buttonRow forward"><?php echo zen_image_submit('', BUTTON_CONTINUE_ALT, 'onclick="submitFunction('.zen_user_has_gv_account($_SESSION['customer_id']).','.$order->info['total'].')"'); ?></div>
<div class="buttonRow back"><br><?php echo TITLE_CONTINUE_CHECKOUT_PROCEDURE . '' . TEXT_CONTINUE_CHECKOUT_PROCEDURE; ?></div>
