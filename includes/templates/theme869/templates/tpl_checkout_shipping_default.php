...
<div class="ui-grid-b ui-responsive"  id="order_steps">
	...
	<?php echo zen_image($template->get_template_dir('arrow_checkout17.png', DIR_WS_TEMPLATE, $current_page_base,'images'). '/' . 'arrow_checkout.gif', ORDER_STEPS_IMAGE_ALT); ?><br /><?php echo zen_image($template->get_template_dir('step1.png', DIR_WS_TEMPLATE, $current_page_base,'images'). '/' . 'step1.png', ORDER_STEPS_IMAGE_ALT, '50%', '50%'); ?><br /><span class="active_step_text"><?php echo TEXT_ORDER_STEPS_1; ?></span><br /><span class="progressbar_inactive_COWOA">&nbsp;</span>
	</div></div>
	<div class="ui-block-b"><div class="ui-body ui-body-d">
	<?php echo zen_image($template->get_template_dir('arrow_checkout17.png', DIR_WS_TEMPLATE, $current_page_base,'images'). '/' . 'arrow_checkout17.png', ORDER_STEPS_IMAGE_ALT); ?><br /><?php echo zen_image($template->get_template_dir('step2.png', DIR_WS_TEMPLATE, $current_page_base,'images'). '/' . 'step2.png', ORDER_STEPS_IMAGE_ALT, '50%', '50%'); ?><br /><span class="order_steps_text"><?php echo TEXT_ORDER_STEPS_2; ?></span><br /><span class="progressbar_inactive_COWOA">&nbsp;</span>
	</div></div>
	<div class="ui-block-c"><div class="ui-body ui-body-d">
	<?php echo zen_image($template->get_template_dir('arrow_checkout17.png', DIR_WS_TEMPLATE, $current_page_base,'images'). '/' . 'arrow_checkout17.png', ORDER_STEPS_IMAGE_ALT); ?><br /><?php echo zen_image($template->get_template_dir('step3.png', DIR_WS_TEMPLATE, $current_page_base,'images'). '/' . 'step3.png', ORDER_STEPS_IMAGE_ALT, '50%', '50%'); ?><br /><span class="order_steps_text"><?php echo TEXT_ORDER_STEPS_3; ?></span><br /><span class="progressbar_inactive_COWOA">&nbsp;</span>
	</div></div>
	<div class="ui-block-d"><div class="ui-body ui-body-d">
	<?php echo zen_image($template->get_template_dir('arrow_checkout17.png', DIR_WS_TEMPLATE, $current_page_base,'images'). '/' . 'arrow_checkout17.png', ORDER_STEPS_IMAGE_ALT); ?><br /><?php echo zen_image($template->get_template_dir('step4.png', DIR_WS_TEMPLATE, $current_page_base,'images'). '/' . 'step4.png', ORDER_STEPS_IMAGE_ALT, '50%', '50%'); ?><br /><span class="order_steps_text"><?php echo TEXT_ORDER_STEPS_4; ?></span><br /><span class="progressbar_inactive_COWOA">&nbsp;</span>
	</div></div>
</div>
    </div>
  <br class="clearBoth" />    
