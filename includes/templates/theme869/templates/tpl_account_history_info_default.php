...
<div class="forward mb"><?php echo HEADING_ORDER_DATE . ' ' . zen_date_long($order->info['date_purchased']); ?></div>

<table class="table table-bordered" width="100%" cellspacing="0" cellpadding="0" summary="Itemized listing of previous order, includes number ordered, items and prices">
<caption>
<div class="heading"><h1><?php echo HEADING_TITLE . ORDER_HEADING_DIVIDER . sprintf(HEADING_ORDER_NUMBER, $_GET['order_id']); ?></h1></div>
...
?>
     <div class="amount"><?php echo $order->totals[$i]['text'] ?></div>
     <div class="lineTitle"><?php echo $order->totals[$i]['title'] ?></div>
<br class="clearBoth" />
<?php
  }
?>
...
echo '&nbsp;'; 
      ...
      if (empty($statuses['updated_by']) || (strpos($statuses['comments'], "<script") !== false)) {
