...
<div class="form-control-block">
    ...
    <div class="form-group">
        <div class="form_btn"><?php echo zen_image_submit('', BUTTON_LOGIN_ALT); ?></div>
        <div class="form_btn1"><?php echo '<a class="btn" href="' . zen_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?></div>
    </div>
    </form>
</div>
<br class="clearBoth" />
