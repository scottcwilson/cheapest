...
<h2 class="centerBoxHeading"><?php echo $products_name . $products_model; ?></h2>
<div class="row">
    ...
    <div class="pb-center-column col-xs-7 col-sm-7">
        ...
        <div class="buttonRow forward"><?php echo '<a class="btn-default" href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS_INFO, 'products_id=' . (int)$_GET['products_id'] . '&reviews_id=' . $reviews['id']) . '">' . zen_image_button(BUTTON_IMAGE_READ_REVIEWS , BUTTON_READ_REVIEWS_ALT) . '</a>'; ?></div>
        ...
        <br />
            <div class="btn-group">
                ...
                <?php echo '<a class="btn-default-small" href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, zen_get_all_get_params(array('reviews_id'))) . '">' . zen_image_button(BUTTON_IMAGE_WRITE_REVIEW, BUTTON_WRITE_REVIEW_ALT) . '</a>'; ?>
                    <?php
                        ...
                        if (zen_has_product_attributes($review->fields['products_id'] )) {
                          ...
                          $link= '<a class="btn-add-small" href="' . zen_href_link($_GET['main_page'], zen_get_all_get_params(array('action', 'reviews_id')) . 'action=buy_now') . '">' . zen_image_button(BUTTON_IMAGE_IN_CART, BUTTON_IN_CART_ALT) . '</a>';
                        }
                        $the_button = $link;
                        $products_link = '';
