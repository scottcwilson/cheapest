...
<div class="ui-grid-b ui-responsive"  id="order_steps">
	...
	<?php echo zen_image($template->get_template_dir('arrow_checkout.gif', DIR_WS_TEMPLATE, $current_page_base,'images'). '/' . 'arrow_checkout.gif', ORDER_STEPS_IMAGE_ALT); ?><br /><?php echo zen_image($template->get_template_dir('step3.png', DIR_WS_TEMPLATE, $current_page_base,'images'). '/' . 'step3.png', ORDER_STEPS_IMAGE_ALT, '50%', '50%'); ?><br /><span class="active_step_text"><?php echo TEXT_ORDER_STEPS_3; ?></span><br /><span class="inactive_spacer">&nbsp;</span>
	</div></div>
