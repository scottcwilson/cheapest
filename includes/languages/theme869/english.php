...
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. &nbsp; Powered by cold pizza & hot coffee!');
...
// used for redeem code, redemption code, or redemption id
  define('TEXT_GV_REDEEM','<span style="color:#0000FF"><b>Enter Coupon Code Here:</b></span>&nbsp;');
...
// reviews box text in sideboxes/reviews.php
  define('BOX_HEADING_REVIEWS', 'Member Reviews');
  define('BOX_REVIEWS_WRITE_REVIEW', 'Tell others what you think, write a review on this product.'); 
...
// information box text in sideboxes/more_information.php - were TUTORIAL_
  ...
  define('BOX_INFORMATION_PAGE_2', 'FAQs');
  define('BOX_INFORMATION_PAGE_3', 'About Us');
  define('BOX_INFORMATION_PAGE_4', 'User Safety');
  define('BOX_INFORMATION_PAGE_5', 'Legal Notice');
  define('BOX_INFORMATION_PAGE_6', 'Link Exchange');
  define('BOX_INFORMATION_PAGE_7', 'Privacy Policy');
...
// javascript messages
  ...
  define('ERROR_CONDITIONS_NOT_ACCEPTED', 'Please confirm the terms and conditions bound to this order by clicking the box below.');
  define('ERROR_PRIVACY_STATEMENT_NOT_ACCEPTED', 'Please confirm the privacy statement by clicking the box below.');

  define('CATEGORY_COMPANY', '<br><font size="3">Which Types Of Banknotes Will You Purchase The Most?&nbsp;&nbsp; <span style="color:#ff0000"> *<i>THIS FIELD IS REQUIRED</i>&nbsp;!</font></span>');
  define('CATEGORY_PERSONAL', 'Your Account Details');
  ...
  define('ENTRY_COMPANY', '<span style="color:#0000ff"><b>Banknotes Most Interested In:</b></span>');
  define('ENTRY_COMPANY_ERROR', 'Please enter a Banknote name.');
  define('ENTRY_COMPANY_TEXT', 'Banknotes');
  define('ENTRY_GENDER', '');
  ...
  define('ENTRY_NICK', 'Forum Avatar Name:');
  ...
  define('ENTRY_STREET_ADDRESS_TEXT', '<br><span style="color:#0000ff">We do <b>NOT</b> accept PO Boxes</font>');
  ...
  define('ENTRY_TELEPHONE_NUMBER', '<br><b>Your Phone #:</b> <br><font size="2"><i>### - ### - ####</i></font>');
  ...
  define('FORM_REQUIRED_INFORMATION', '<font size="2">The&nbsp; " * " &nbsp; Symbol in the form below, indicates <b><u>REQUIRED</u> Information</b></font><br><br>');
...
// IP Address
  define('TEXT_YOUR_IP_ADDRESS','We Are Tracking You And Your IP Address Is: '); 
...
// banner box 2
  define('BOX_HEADING_BANNER_BOX2','Currency Rates'); 
...
define('TEXT_BEFORE_DOWN_FOR_MAINTENANCE', '<b>NOTICE:</b>&nbsp; This website is scheduled to be down for routine maintenance on: ');
define('TEXT_ADMIN_DOWN_FOR_MAINTENANCE', '<b>NOTICE:</b>&nbsp; The website is currently Down For Maintenance and therefore not accessible to the public during this maintenance period.&nbsp; No worries, we will be back online momentarily.&nbsp; Thank you for your patience.');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_FEATURED_PRODUCTS','This Weeks Featured Products');

  define('TABLE_HEADING_NEW_PRODUCTS', 'New Products Added In %s');
  define('TABLE_HEADING_UPCOMING_PRODUCTS', 'Upcoming Products');
  define('TABLE_HEADING_DATE_EXPECTED', 'Date Expected');
  define('TABLE_HEADING_SPECIALS_INDEX', 'On Sale This Week ...');
...
// set for login for prices
  define('TEXT_LOGIN_FOR_PRICE_PRICE','<span style="color:#5b5b5b;">Member Only Prices</span>'); 
...
// authorization pending
  define('TEXT_AUTHORIZATION_PENDING_PRICE', 'Prices Unavailable To Unapproved Members');
  define('TEXT_AUTHORIZATION_PENDING_BUTTON_REPLACE', 'MEMBERSHIP APPROVAL PENDING. Please review your Welcome Email to discover your activation date');
...
// create account - login shared
  ...
  define('ENTRY_EMAIL_PREFERENCE','<br><br><font size="4">Want To Receive Newsletters & Sale Notifications?</font></b><br>  <font size="2"><i>We will only send an average of 1-2 emails every couple months.</i><br> Choose your email preference below for sales images, then click "Update"</font><br><br>');
  define('ENTRY_EMAIL_HTML_DISPLAY','&nbsp; Allow Images&nbsp;');
...
define('BOX_HEADING_SOCIAL', 'Information');
define('BOX_HEADING_MENU', 'MENU');
define('ENTRY_NAME', 'Full Name:');
define('ENTRY_EMAIL', 'Email Address:');
define('ENTRY_ENQUIRY', 'Message:');

// header extra boxes
define('STORE_TELEPHONE_CUSTSERVICE1', '(855) 780-1083');
define('STORE_SHIPPING1', 'Free Shipping');
define('STORE_SHIPPING2', 'on orders over $50');
define('STORE_SHIPPING3', 'This offer is valid on all our store items.');
define('ENTRY_CUSTOMERS_REFERRAL', 'Referral Code:');

define('EXPECTED_DATE','Expected date');
// menu title in adaptive version
